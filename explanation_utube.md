...
Install Dependencies: Run:pip install pandas numpy matplotlib seaborn networkx textblob sentence-transformers umap-learn gensim scikit-learn transformers scattertext


Prepare Data: Place Youtube_scrapping_comments.csv in the same folder as the notebook.
Run the Notebook: Open Youtube_Data_analysis&Visualisation.ipynb in Jupyter Notebook and execute cells sequentially.
View Outputs: Check tables, charts, and graphs generated in the notebook.
